# -*- coding: utf-8 -*-
"""
Rich console UI components for Onchain Accounting.
"""
...
def print_banner():
    ...
    console.print(
        Panel(
            ...
            "[dim]Privacy-First On-Chain Accounting & Tax Engine[/dim]",
...
def show_menu_table(menu_items):
    ...
    choice = console.input("[bold bright_yellow]  Select option >[/] ").strip()
    return choice
...
def progress_bar(description, total=100, transient=False):
    return Progress(
        ...
        BarColumn(bar_width=40, complete_style="bright_yellow", finished_style="bright_green"),
